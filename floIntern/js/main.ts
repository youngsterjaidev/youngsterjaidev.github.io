            ...
            class MyCard extends HTMLElement {
                ...
                render(): string {
                    if (finalList.length) {
                        ...
                        myResult.forEach((r) => {
                            let username: HTMLHeadElement = document.createElement("h2");
                            username.innerText = r.name;
                            username.style.textAlign = "center";
                            let txData: HTMLUListElement = document.createElement("ul");
                            ...
                            r.transactions.forEach((t) => {
                                ...
                                let li:HTMLLIElement = document.createElement("div");
